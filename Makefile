...
download:
	...
	cd $(TMP_DIR)opencv
	curl -Lo opencv.zip https://ghproxy.com/https://github.com/opencv/opencv/archive/$(OPENCV_VERSION).zip
	unzip -q opencv.zip
	curl -Lo opencv_contrib.zip https://ghproxy.com/https://github.com/opencv/opencv_contrib/archive/$(OPENCV_VERSION).zip
...
download_openvino:
	...
	sudo git clone https://ghproxy.com/https://github.com/openvinotoolkit/openvino -b 2019_R3.1 /usr/local/openvino/
